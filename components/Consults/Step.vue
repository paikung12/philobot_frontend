    ...
    <div>
        ...
        <div class="flex">
            <div class="w-1/3 text-center px-6">
                <div class="bg-white rounded-lg flex items-center justify-center shadow-lg shadow-gray-200">
                    ...
                    <div class="w-2/3 bg-white h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
