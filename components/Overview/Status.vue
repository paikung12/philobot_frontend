...
<div>
    <div class="flex flex-wrap -mx-1  sm:-mx-1 md:-mx-1 lg:-mx-1 xl:-mx-1">
        <div class="my-1 px-1 w-full  sm:my-1 sm:px-1 sm:w-full md:my-1 md:px-1 md:w-full lg:my-1 lg:px-1 lg:w-full xl:my-1 xl:px-1 xl:w-2/5">
            <v-img class="rounded-2xl " width="190" height="180" src="https://cdn.dribbble.com/users/22930/screenshots/2784925/robot_upscale.gif"></v-img>
        </div>
            ...
            <div class="flex flex-wrap -mx-1  sm:-mx-1 md:-mx-1 lg:-mx-1 xl:-mx-1">
                <div class="my-1 px-1 w-full  sm:my-1 sm:px-1 sm:w-full md:my-1 md:px-1 md:w-full lg:my-1 lg:px-1 lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <v-chip class="ma-2 shadow-lg" color="#ffff" label text-color="white">
                        ...
                        <span class="ml-1 text-gray-900 font-sans ">BTC / USDT</span>
                    </v-chip>
                </div>
                <div class="my-1 px-1 w-full  sm:my-1 sm:px-1 sm:w-full md:my-1 md:px-1 md:w-full lg:my-1 lg:px-1 lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <v-chip class="ma-2 shadow-lg" color="#ffff" label text-color="white">
                        ...
                        <span class="ml-1 text-gray-900 font-sans"> XRP / USDT </span>
                    </v-chip>
                </div>
                <div class="my-1 px-1 w-full  sm:my-1 sm:px-1 sm:w-full md:my-1 md:px-1 md:w-full lg:my-1 lg:px-1 lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <v-chip class="ma-2 shadow-lg" color="#ffff" label text-color="white">
                        ...
                        <span class="ml-1 text-gray-900  font-sans"> ETH / USDT </span>
                    </v-chip>
                </div>
                <div class="my-1 px-1 w-full  sm:my-1 sm:px-1 sm:w-full md:my-1 md:px-1 md:w-full lg:my-1 lg:px-1 lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <v-chip class="ma-2 shadow-lg" color="#ffff" label text-color="white">
                        ...
                        <span class="ml-1 text-gray-900 font-sans"> BNB / USDT </span>
                    </v-chip>
                </div>
            </div>
        </div>
    ...
    <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl mt-12 ">
        ...
        <div class="mt-6">
            <h5 class="text-xl text-gray-700 text-center">Target Trade</h5>
            <div class="mt-6 flex flex-wrap -mx-px overflow-hidden sm:-mx-px md:-mx-px lg:-mx-px xl:-mx-1">

                <div class="my-px px-px w-full overflow-hidden sm:my-px sm:px-px sm:w-full md:my-px md:px-px md:w-full lg:my-px lg:px-px lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Target Trade</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-green-400">+235%</h3>
                        </div>
                ...
                <div class="my-px px-px w-full overflow-hidden sm:my-px sm:px-px sm:w-full md:my-px md:px-px md:w-full lg:my-px lg:px-px lg:w-full xl:my-1 xl:px-1 xl:w-1/2">
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Current of Trade</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-green-400">+74%</h3>
                        </div>
                        <span class="block text-center text-gray-500">Compared to last week $13,988</span>
                    </div>
                </div>
