...
<div>
    <div class="">
        <h1 class="mb-4 text-center font-black text-gray-700"></h1>
        <div class="flex">
            <div class="w-1/3 text-center px-6">
                <div class=" valhalla bg-white rounded-lg flex items-center justify-center shadow-lg  ">
                    ...
                    <div class=" valhalla w-2/3 bg-white h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
                        <h2 class="font-bold text-green-400 text-sm">Step 1</h2>
                        <p class="text-xs text-gray-400">
                            Choose a Profit Test Robot
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3 text-center px-6">
                <div class="valhalla bg-white rounded-lg flex items-center justify-center shadow-lg  ">
                    ...
                    <div class="valhalla w-2/3 bg-white h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
                        <h2 class="font-bold text-sm text-green-400 ">Step 2</h2>
                        <p class="text-xs text-gray-400">
                           Customize the robot settings to your liking.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3 text-center px-6">
                <div class=" valhalla bg-white rounded-lg flex items-center justify-center shadow-lg ">
                    <div class="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step">
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                            <path d="M21 6.285l-11.16 12.733-6.84-6.018 1.319-1.49 5.341 4.686 9.865-11.196 1.475 1.285z" /></svg>
                    </div>
                    <div class="valhalla w-2/3 bg-white h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
                        <h2 class="font-bold text-sm text-green-400 ">Step 3</h2>
                        <p class="text-xs text-gray-400">
                            Wait for the results of the profit test.
                        </p>
                    </div>
                </div>
            </div>
