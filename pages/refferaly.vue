            ...
            <div class="bg-purple-400 md:overflow-hidden">
                <div class="px-4 py-16">
                    <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                        ...
                        <div class="hidden md:block h-5 w-5 rounded-full bg-purple-300 absolute top-0 right-0 -mr-40 mt-32"></div>
                        <div class="hidden md:block h-5 w-5 rounded-full bg-purple-300 absolute top-0 right-0  mt-32"></div>                                           
                    </div>
                </div>

                <svg class="fill-current bg-purple-400 text-white hidden md:block -mt-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
